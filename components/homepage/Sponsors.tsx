...
export default function Sponsors() {
    ...
    return (
        <section className="min-h-screen flex items-center justify-center">
            <div ref={sponsorsRef} className="bg-gradient-to-br from-purple-500/20 to-blue-500/20 backdrop-blur-sm border border-white/20 rounded-2xl p-8 md:p-12 max-w-5xl mx-4 text-white">
