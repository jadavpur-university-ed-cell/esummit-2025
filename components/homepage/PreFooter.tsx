...
import Image from "next/image"; 
   export default function PreFooter() {
    return (
      <main className="mt-1 mx-auto px-4 sm:mt-8 min-h-[40vh] bg-gradient-to-b from-transparent via-indigo/70 to-indigo">
          <div className="text-center">
            ...
            <Image
                ...
                height={600}
                width={600}
                className="object-cover aspect-video w-[125px] h-[70px] md:w-[175px] md:h-[100px] 2xl:w-auto 2xl:h-[150px]"
                />
                </div>
             <h1 className="text-4xl font-light"><br/>IDEATE | INNOVATE | BUILD</h1>
           </span>
          </div>
        </main>
    )
