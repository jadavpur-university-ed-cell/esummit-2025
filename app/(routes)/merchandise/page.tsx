                ...
                <div className="container px-5 py-8 mx-auto">
                    <div className="lg:w-4/5 mx-auto flex flex-wrap">
                        ...
                        <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                            ...
                            <h1 className="text-[#fcbf49] text-2xl title-font font-semibold mb-1">Get the official E-Summit 25 Merchandise</h1>
                            ...
                            <div className="flex my-6">
                                ...
                                <button
                                    className="flex ml-auto bg-[#fcbf49] text-[#101720] font-semibold border-0 py-2 px-6 focus:outline-none hover:bg-[#EAE2B7] rounded-full"
