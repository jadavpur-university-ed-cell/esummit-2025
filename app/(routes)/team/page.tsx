...
//           {/* Team Tabs */}
//           <div className="sm:block bg-[#101720] rounded-xl shadow-lg">
...
//                       : 'text-[#eae2b7] hover:bg-[#c085fd]/20',
//                     tabIdx === 0 ? 'rounded-l-full' : '',
//                     tabIdx === teams.length - 1 ? 'rounded-r-full' : '',
//                     'group relative min-w-0 flex-1 py-3 px-4 text-sm font-medium text-center transition-all duration-200'
//                   )}
...
//         </div>
//       </div>
//     <div className="max-w-7xl mx-auto py-2 px-4 pb-10">
//       <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 md:gap-12 lg:gap-16">
//         {activeMembers.map((member, idx) => (
//       <div key={idx} className="relative w-full aspect-[5/5] overflow-hidden rounded-xl">
//        <DirectionAwareHover imageUrl={member.imageUrl} className="relative h-full w-full overflow-visible">
//       <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-transparent to-transparent" />
//       <div className="absolute bottom-4 left-4">
//         <p className="font-bold text-xl text-white">{member.name}</p>
//         <p className="font-normal text-sm text-[#eae2b7]">{member.role}</p>
...
//               className="p-2 bg-black/60 rounded-full hover:bg-pink-600 transition duration-200"
//             >
...
//               rel="noopener noreferrer"
//               onClick={(e) => e.stopPropagation()}
//               className="p-2 bg-black/60 rounded-full hover:bg-blue-700 transition duration-200"
//             >
...
export default function TeamsPage() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      if (!mobileCheck) {
        // Parallax background animation - show more of the SVG
        gsap.to(backgroundRef.current, {
          x: "-40%", // Increased to show more of the right side
          ease: "none",
          scrollTrigger: {
            trigger: containerRef.current,
            start: "top top",
            end: "bottom bottom",
            scrub: 1.5, // Slower scrub for smoother effect
          },
        });
      }
    ...
    <div ref={containerRef} className="relative w-full min-h-screen">
      ...
      <div 
        ...
        style={{
          ...
          backgroundSize: 'auto 120%', // Show more height
          backgroundRepeat: 'no-repeat',
          backgroundPosition: 'left center',
          width: '150vw', // Extended width to show more of the SVG
          height: '120vh', // Extended height
          minWidth: '100vw',
          minHeight: '100vh',
        }}
      >
