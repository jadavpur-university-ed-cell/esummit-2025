...
export default function Page() {
  ...
  const eventDetails = workshopData.find((e: Event) => e.eventSlug === eventSlug);
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-b from-slate-800 via-slate-900 to-black text-white pt-25">
      {/* Navigation */}
